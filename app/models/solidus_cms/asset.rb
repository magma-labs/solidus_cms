...
module SolidusCms
  class Asset < ::Spree::Asset
    has_attached_file :attachment,
                      ...
                      url: '/solidus_cms/assets/:id/:style/:basename.:extension',
                      path: ':rails_root/public/solidus_cms/assets/:id/:style/:basename.:extension',
    ...
    before_post_process -> { !Rails.env.test? && !new_record? }
